...
<body>
    ...
    <div class="header" style="background-color: white;">
        ...
        <div class="header-right">
            ...
            <a href="painelServCad.php?edit=<?php echo $linha['usuario_id']; ?>" > Meus Serviços</a> 
            <a href="painelPedRec.php?edit=<?php echo $linha['usuario_id']; ?>" > Pedidos Recebidos</a> 
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Cadastrar Serviço </h3>
                    <?php
                    if($_SESSION['status_cadastroServ']):
                    ?>
                        <div class="notification is-success">
                        <p>Cadastro efetuado!</p>
                        <p>Veja seus serviços cadastrados<a href="painelServCad.php?edit=<?php echo $linha['usuario_id']; ?>" > aqui</a></p>
                        </div>
                    <?php
                    endif;
                    ...
                    <div class="box">
                        ...
                        <div class="field">
                                <div class="control">
									<input name="usuario_id" type="hidden" value="<?php echo $linha['usuario_id']; ?>" placeholder="Nome" autofocus>
                                    <textarea style="width: 300px; height:150px;" name="descricao" type="text" class="input is-large" placeholder="Descrição" autofocus></textarea>
                                </div>
                        </div>
